...
<html lang="en">
  ...
  <head>
    ...
    <title>Login</title>
    {{-- <link rel="shortcut icon" href="{{ asset('/asset/images/logo/favourite_icon_1.svg') }}"> --}}
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col col-lg-5">
                <h1 class="register_heading text-center">Login Akun</h1>
                ...
                <form action="/log_process" method="POST">
                  ...
                  <div class="register_form signup_login_form">
                    ...
                    <div class="remenber_forget row mb-3 align-items-center justify-content-between">
                      <div class="col col-6">
                        <div class="checkbox_item mb-0">
                          ...
                          <label for="checkbox_remenber">Ingat aku</label>
                        </div>
                      </div>
                      <div class="col col-6">
                    ...
                    <p class="mb-0 text-center">tidak punya akun? <a href="/layout/signup">Daftar Disini</a></p>
                  </div>
                </form>
              </div>
            </div>
